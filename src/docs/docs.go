...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/accounts/{number}/contacts/sync": {
            "post": {
        ...
        "/v1/accounts/{number}/contacts/{uuid}": {
            "get": {
        ...
        "/v1/accounts/{number}/contacts/{uuid}/avatar": {
            "get": {
        ...
        "/v1/accounts/{number}/devices/{deviceId}": {
            "delete": {
        ...
        "/v1/accounts/{number}/groups/{groupId}": {
            "get": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/admins": {
            "post": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/avatar": {
            "get": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/block": {
            "post": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/join": {
            "post": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/members": {
            "post": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/pinned-message": {
            "post": {
        ...
        "/v1/accounts/{number}/groups/{groupId}/quit": {
            "post": {
        ...
        "/v1/accounts/{number}/identities/{id}/trust": {
            "put": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/storage.StoredMessage"
                            }
                        }
                    },
                    "400": {
        ...
        "/v1/accounts/{number}/messages/history": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter by minimum timestamp (milliseconds since epoch)",
                        "name": "start_time",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Filter by maximum timestamp (milliseconds since epoch)",
                        "name": "end_time",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Comma-separated envelope types to include (default: dataMessage)",
                        "name": "envelope_type",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Filter by retrieved flag (omit for all, true/false to filter)",
                        "name": "retrieved",
                        "in": "query"
                    },
                    {
        ...
        "/v1/accounts/{number}/messages/remote-delete": {
            "post": {
        ...
        "/v1/accounts/{number}/messages/stream": {
            "get": {
        ...
        "/v1/accounts/{number}/qr-code/raw": {
            "get": {
        ...
        "/v1/accounts/{number}/register/verify/{token}": {
            "post": {
        ...
        "/v1/accounts/{number}/sticker-packs": {
            "get": {
